...
class Face(InferBin):
    def __init__(self, pipeline, srcm, perf) -> None:
        ...
        self.config_path = os.path.join(config.__path__[0], 'config_app_face.txt')
        self.pgie_config_path = os.path.join(config.__path__[0], 'config_trt_retinaface.txt')
        self.sgie_config_path = os.path.join(config.__path__[0], 'config_trt_arcface.txt')
